...
api.LoadScene('scenario_1_part_2.scn', 'scene')
...
voice_over = api.PlaySound('sounds/voice_over/s1_voice_03.ogg', 1.0)
...
api.GoToNode("interaction_point_rest_bench_1")

api.WaitFor(0.5)

api.GoToNode("interaction_point_rest_bench_2")

api.WaitFor(0.5)

voice_over = api.PlaySound('sounds/voice_over/s1_voice_04.ogg', 1.0)
api.WaitSource(voice_over)

api.WaitFor(0.5)

-- END
api.ChangeScenario('scenario_001_part_003')
-- api.EndCapture()
