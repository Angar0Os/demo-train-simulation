...
if CONFIGURATION == "Etat actuel" then
    api.LoadScene('scenario_2_part_3.scn', 'scene')
...
elseif CONFIGURATION == "Piste 3 - Ascenseur" then
    api.LoadWaypoints('../sncf-reims-2025/scenarios/scenario_2_part_3b.waypoints')
    api.LoadScene('scenario_2_part_3b.scn', 'scene')
...
local sgn_reperes_voies_quai_anim = api.PlayNodeAnimation("sgn_reperes_voies_quai", "scenario_2_depart_state_2")
...
voice_over = api.PlaySound('sounds/voice_over/s2_voice_05.ogg', 1.0)
...
if CONFIGURATION == "Piste 3 - Ascenseur" then
    ...
    sgn_reperes_voies_quai_anim = api.PlayNodeAnimation("sgn_reperes_voies_quai", "scenario_2_depart_state_3")
...
train1 = api.PlayNodeAnimation("train_track_V", "open_doors_left")
--WaitAnimation(train1)
api.WaitFor(3.0)

api.GoToNode("interaction_point_end")

train2 = api.PlayNodeAnimation("train_track_V", "close_doors_left")
