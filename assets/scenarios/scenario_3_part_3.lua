...
api.LoadScene('scenario_3_part_3.scn', 'scene')
...
voice_over = api.PlaySound('sounds/voice_over/s3_voice_06.ogg', 1.0)
...
sgn_reperes_voies_quai_anim = api.PlayNodeAnimation("sgn_reperes_voies_quai", "scenario_3_depart_state_2")
api.TeleportToWaypoint(6)

api.GoToNode("interaction_point_vo")

voice_over = api.PlaySound('sounds/voice_over/s3_voice_07.ogg', 1.0)
api.WaitSource(voice_over)

api.GoToNode("interaction_point_end")

-- END
api.ChangeScenario('scenario_003_part_004')
-- api.EndCapture()